    ...
    <div style="float: left;">
        ...
        <div data-bind="event: { mouseover: helpers.onMouseOver, mouseleave: helpers.onMouseLeave }">
            <div style="margin: 4px;">
                ...
                <!--/ko-->
                <img data-bind="attr: { src: PhotoPath, 'data-url': PhotoFullView, 'data-width': PopupWidth, 'data-height': PopupHeight, 'data-pos': Position }" style="width: 175px; cursor: pointer;" class="photoThumb" />
            </div>
        </div>
        <!--/ko-->
    </div>
