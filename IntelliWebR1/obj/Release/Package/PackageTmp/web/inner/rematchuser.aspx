...
<form runat="server">
    <div style="width: 600px; min-height: 330px; border: 0px solid #ccc; margin: 0 auto; font-family: Arial; border-radius: 2px 4px;background:#fff;" id="divCanSend" runat="server" visible="true">
