...
<script type="text/html" id="template_criteriaedit">
    ...
    <div class="ButtonsArea" style="padding-right: 30px;">
      ...
      <div class="FloatLeft">
            <div id="btnClearAnswer" style="cursor:pointer;text-decoration:underline;margin-left: 30px;margin-top: 20px;" data-bind="event: { click: ClearAnswer }">Clear Answer</div>
        </div>
