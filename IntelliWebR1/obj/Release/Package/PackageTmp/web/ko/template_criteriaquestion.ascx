        ...
        <div class="gradientGrey CriteriaGradientBox" data-bind="attr: { id: QuestionDivID }">
            <div style="float: left; width: 100%;height:44px;">
                <div style="float: left; width: 40%;">
                    ...
                    <div>                      
                     <img src="images/02_back.png" alt="back" style="margin-left: -50px;height: 38px;" data-bind="event: { click: BackClick }" />                     
                    </div>
                    <!--/ko-->
             ...
             <section>
                ...
                <div class="QuestionArea" style="border: 0px solid; float: left;">
                    ...
                    <div class="SelectionArea">
                        <div class="SelectionQuestion"  style="padding-left: 4px;font-size: 14px;color: #2d2929;font-weight: 600;" data-bind="text: CriteriaQuestion"></div>
                    ...
                    <div class="SelectionArea">
                        <!--ko if:ShowPartTwo-->
                        <div class="SelectionQuestion" style="padding-left: 4px;font-size: 14px;color: #2d2929;font-weight: 600;" data-bind="text: CriteriaPreferenceQuestion"></div>
                        <div class="SelectionQuestion SelectionQuestionMargins">
