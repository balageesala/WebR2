<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlaCartePayment.aspx.cs" Inherits="IntellidateR1Web.web.AlaCartePayment" %>
...
<form id="NewPaymentForm" method="post" action="<%= braintreeGateway().TransparentRedirect.Url %>">
		...
		<% } else { %>
            ...
            <br />
            <div id="divCartDetails" runat="server"></div>
			<div id="divCartPrice" runat="server"></div>
            <br />
			<p>
