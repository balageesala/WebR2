<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="template_criteriaeditpopup.ascx.cs" Inherits="IntelliWebR1.web.ko.template_criteriaeditpopup" %>

<script type="text/html" id="template_criteriaeditpopup">

    <!--ko if:ShowEditItem-->
    <div class="criteriatemp">
        <div class="editcriterianame" data-bind="text: CriteriaName"></div>
        <div class="hundred"><div id="divAssignPoints"></div><span class="ChangeThisCriteria" data-bind="attr: { 'data-id':_id }" >Change Points</span></div>
