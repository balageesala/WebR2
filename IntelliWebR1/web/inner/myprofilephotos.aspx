...
<script type="text/html" id="template_myprofilephotos">
    <div style="float: left;margin-left:0px;">
        ...
        <div data-bind="event: { mouseover: helpers.onMouseOver, mouseleave: helpers.onMouseLeave }">
            <div style="margin: 2px;border:1px solid #ccc;width: 174px;">
                <img data-bind="attr: { src: PhotoPath, 'data-url': EncryptPath, 'alt': Caption, 'data-pos': Position }" style="width: 174px;min-height:80px; cursor: pointer;" class="photoThumb" />   
