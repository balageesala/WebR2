...
<body>
    ...
    <div class="upload_image">
        <div style="float: left; margin-left: 34px; margin-top: 6px;">
            Avilable photos :
                <div id="divAvilable" style="float: right;" runat="server"></div>
        </div>
        <a class="close" id="btnClose" style="cursor:pointer;">x</a>
        <span class="clear"></span>
        <div class="upload_image_cont" id="imgPreviews">
        ...
        <input type="button" class="send" value="Done" id="btnDone" />
        <span class="clear"></span>
    </div>
