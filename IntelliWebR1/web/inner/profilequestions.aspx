    ...
    <asp:repeater id="rptPhilosophyMatch" runat="server" onitemdatabound="rptPhilosophyMatch_ItemDataBound" >
                <ItemTemplate>
                    <asp:Panel ID="pnlAnswered" runat="server">
                        <div style="min-height: 40vh;float:left;margin-top:10px;">
                        <div class="talking fl" style="margin-left:40px;float:left;">
                            ...
                            <div style="text-align: right;">
                                <img src="images/Discuss94.png" id="btnChatAboutIt" data-width="500" data-height="320" class="ChatAboutIt" style="cursor:pointer;" runat="server"  />
                              </div>
</div>
                            </div>
</asp:Panel>
    ...
    $(document).ready(function () {
        ...
        $(".answerQuestion").click(function () {
            try {
                ...
                SetUrlIntelliWindow(_AnswerQuestionUrl, "700", "500");
            } catch (ex) {
