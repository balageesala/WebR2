...
$(document).ready(function () {
    ...
    $.postDATA(API_OTHERUSER_PROFILE, _Object, function (_ret) {
        ...
        $(".ChatAboutIt").click(function () {
            var _AnswerID = $(this).data('id');
         //   alert(_AnswerID);
            var _DiscussPopupUrl = _SitePath + "web/inner/aboutmediscuss?wid=" + _AnswerID;

            SetUrlIntelliWindow(_DiscussPopupUrl, "650", "480");
...
function VMDescriptionAnswersList(_list) {
    ...
    ToDiscuss = function (_data) {
       // alert(_data.AnswerID());
        var _DiscussPopupUrl = _SitePath + "web/inner/aboutmediscuss?wid=" + _data.AnswerID();
      //  SetUrlIntelliWindow(_DiscussPopupUrl, "650", "480");
    };
