...
{
    public class PostCriteriaUserAnswerController : ApiController
    {
        public CriteriaUserAnswerWeek Post([FromBody]PostCriteriaUserAnswer ac)
        {
            int UserID = ac.UserID;
            CriteriaUserAnswerWeek m_CriteriaUserAnswer = new CriteriaUserAnswerWeek();
            bool IsHasUserMatch = new UserTodayMatch().IsGetUserMatch(ac.UserID);
    ...
    public class PostCriteriaUserAnswer
    {
